...
export default function ChestCard({ startColour, endColour, image, onclick }) {
  return (
    ...
    >
      ...
      >
        <img
          className="h-[100px] w-[100px] m-auto object-contain"
          src={image}
        />
      </div>
      <div className="flex justify-between mt-2">
        <p className="font-SatoshiBold text-sm">Rare Chest</p>
        <div className="flex items-center">
          <p className="font-SatoshiMedium text-xs">10,000</p>
          <img className="ml-1" src={yellowDiamond} />
        </div>
      </div>

      <div className="flex justify-between mt-1.5">
        <p className="font-SatoshiMedium text-xs text-grey">Slots</p>
        <div className="flex align-items">
          <p className="font-SatoshiMedium text-xs">125/125</p>
        </div>
      </div>

      <div className="flex justify-between mt-1.5">
        <p className="font-SatoshiMedium text-xs text-grey">Opens in</p>
        <div className="flex align-items">
