  ...
  return (
    ...
    >
      <div className="flex items-align">
        ...
        <div className="ml-1">
          <p className="text-left font-SatoshiBold text-lg mt-2">{ele.title}</p>
          <p className="text-left font-SatoshiMedium text-base sm:hidden">
            {ele.description}
          </p>
        </div>
      </div>
  ...
  return (
    ...
    >
      <div className="flex items-align">
        ...
        <div className="ml-1">
          <p className="text-left font-SatoshiBold text-lg sm:mt-2">
            {ele.title}
          </p>
          <div>
            <p className="text-left font-SatoshiMedium text-base lg:block md:block sm:hidden">
              {ele.description}
            </p>
          </div>
        </div>
