      ...
      <div className="flex items-align">
        ...
        <div className="ml-1">
          ...
          <p className="text-left font-SatoshiMedium text-base">
            🎁 Get 1 coin per swap volume of $1 in Volt.
          </p>
        </div>
      </div>
...
export const TaskX = ({ onclick }) => {
  return (
    <div
      onClick={onclick}
      className="w-full h-[64px] rounded-md bg-greyVeryLight flex align-items justify-between p-2 task-holder mt-5"
    >
      <div className="flex items-align">
        ...
        <div className="ml-1">
          ...
          <p className="text-left font-SatoshiMedium text-base">
            🎁 Get 1 coin per swap volume of $1 in X.
          </p>
        </div>
      </div>
      <div className="px-2 rounded-full bg-white flex items-center justify-center max-h-10 ">
