  ...
  return (
    <div className="">
      <Navbar
        ...
        handleOpenCoin={handleOpenCoin}
      />

      <div className="w-11/12 mx-auto flex items-start sm:flex sm:flex-wrap">
        <div className="w-4/6 sm:w-full sm:p-2">
          ...
          <p className="font-SatoshiMedium text-base text-grey text-left mt-3">
            Earn coins to buy chest and get Defy Insiders NFT collection and
            early access to app.
          </p>
          <div className="flex mt-8 sm:flex sm:flex-wrap">
            <ChestCard
          ...
          <div className="flex justify-start align-items sm:overflow-auto">
            <div
            ...
            >
              <p
                className={
                  category == 5 ? "selected" : "unselected !text-green"
                }
              >
                Completed(10)
              </p>
        ...
        <div className="w-2/6 flex flex-col items-end justify-center px-8 sm:w-full sm:mt-6">
          <div
            className="w-full h-auto rounded-2xl bg-greyVeryLight stroke-borderGrey border-l relative px-6 py-4 "
            style={{
          ...
          >
            <div className="sm:flex-row sm:w-full">
          ...
          <div className="w-full bg-bgBlue rounded-2xl p-4 my-5">
            <div className="flex items-align justify-between">
              <div className="flex items-align sm:mt-4">
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <div
                ...
                className="px-2.5 py-1.5 rounded-xl bg-black flex  items-center justify-center cursor-pointer"
              >
          ...
          <div className="w-full  rounded-2xl px-5 py-6 purple-gradient">
            ...
            <div className="flex items-center justify-between ">
              <p className="font-Satoshi text-sm text-white text-left">
                Raffle your favorite NFT and
                <br />
                make great potential.
              </p>
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <div
                onClick={handleOpenChooseNFT}
                className="px-6  py-2.5 rounded-lg bg-white flex  items-center justify-center cursor-pointer sm:w-full"
              >
